...
*@FileName : JooArMgmtDBDAOJooArMnVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooArMgmtDBDAOJooArMnVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooArMgmtDBDAOJooArMnVOUSQL(){
		setQuery();
		...
		query.append("FileName : JooArMgmtDBDAOJooArMnVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
