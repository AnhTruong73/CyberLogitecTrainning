...
*@FileName : FracticeFrameworkDBDAODetailsVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FracticeFrameworkDBDAODetailsVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FracticeFrameworkDBDAODetailsVORSQL(){
		setQuery();
		...
		query.append("FileName : FracticeFrameworkDBDAODetailsVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
