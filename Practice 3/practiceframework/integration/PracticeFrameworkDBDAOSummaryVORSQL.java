...
*@FileName : PracticeFrameworkDBDAOSummaryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PracticeFrameworkDBDAOSummaryVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PracticeFrameworkDBDAOSummaryVORSQL(){
		setQuery();
		...
		query.append("FileName : PracticeFrameworkDBDAOSummaryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
