...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.clv.practicetraining.errmsgmgmt.integration;
...
public class ErrMsgMgmtDBDAOErrMsgVORSQL implements ISQLTemplate{
	...
	public ErrMsgMgmtDBDAOErrMsgVORSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.practicetraining.errmsgmgmt.integration").append("\n"); 
