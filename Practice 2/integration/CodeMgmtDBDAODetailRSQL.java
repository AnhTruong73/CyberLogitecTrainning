...
*@FileName : CodeMgmtDBDAODetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAODetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Code Management List Detail
	  * </pre>
	  */
	public CodeMgmtDBDAODetailRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAODetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
