...
*@FileName : CodeMgmtDBDAODetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAODetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add new detail to database
	  * </pre>
	  */
	public CodeMgmtDBDAODetailCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAODetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
