...
*@FileName : CodeMgmtDBDAODetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAODetailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAODetailUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAODetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	APLY_END_DT = TO_DATE(@[aply_end_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	APLY_ST_DT = TO_DATE(@[aply_st_dt],'YYYY-MM-DD')" ).append("\n"); 
