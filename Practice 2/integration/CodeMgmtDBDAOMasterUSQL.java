...
*@FileName : CodeMgmtDBDAOMasterUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOMasterUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Updata in table Master
	  * </pre>
	  */
	public CodeMgmtDBDAOMasterUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOMasterUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
