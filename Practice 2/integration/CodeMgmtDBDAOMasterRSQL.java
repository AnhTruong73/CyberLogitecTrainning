...
*@FileName : CodeMgmtDBDAOMasterRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOMasterRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Code Management List Master
	  * </pre>
	  */
	public CodeMgmtDBDAOMasterRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOMasterRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
