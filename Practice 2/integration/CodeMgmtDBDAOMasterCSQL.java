...
*@FileName : CodeMgmtDBDAOMasterCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOMasterCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insert new code to master table
	  * </pre>
	  */
	public CodeMgmtDBDAOMasterCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOMasterCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
